...
> 25Warning: `onStart` will not be fired for `autoPlay` animations.
...
> 25Warning: `onProgress` will not be fired in case of ♾️ infinite repeats.
...
> 25Warning: `asyncOnProgress` will not be fired in case of ♾️ infinite repeats.
