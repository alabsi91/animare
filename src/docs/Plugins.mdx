...
- ### ease
  ...
  Check out [`easings.net`](https://easings.net/) to learn more.

> 25Tip: Use the [`animare-ease-visualizer`](https://animare-ease-visualizer.netlify.app/) tool to create custom easing functions.

> 25Warning: custom easing functions may cause frame rate drops.

```typescript margin="25"
...
// The spring easing function will only look smooth at certain durations,
...
> 25Tip: `organize` plugin can handle color animations for you.
