...
> Tip: Use the [`animare-ease-visualizer`](https://animare-ease-visualizer.netlify.app/) tool to create custom easing functions.

> Warning: custom easing functions may cause frame rate drops.
