...
An array of [`AnimationOptions`](/api/objects/animationoptions/) objects.
...
Access the [`AnimationInfo`](/api/objects/animationinfo) object by the animation name.
...
Access the [`AnimationInfo`](/api/objects/animationinfo) object by the animation index.
...
See: [TimelineOptions](/api/objects/timelineoptions/)
